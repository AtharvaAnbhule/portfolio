...
export const metadata: Metadata = {
  title: "Atharva's | Personal Protfolio",
  description: "Atharva is a Software Engineer.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body className={`${inter.className} bg-gray-50 text-text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-50`}>
