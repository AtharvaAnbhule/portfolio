    ...
    <section ref={ref} id="experience" className="scroll-mt-28 mb-28 sm:mb-40">
        ...
        <VerticalTimeline lineColor="">
            {experiencesData.map((item,index) => (
                ...
                <VerticalTimelineElement visible={true} contentStyle={{background:theme === "light" ? "#f3f4f6" : "rgba(255,255,255,0.05)",boxShadow:"none",border:"1px solid rgba(0,0,0,0.05)",textAlign:"left",padding:"1.3rem 2rem"}}
